...
Image locators allow you to identify test objects with images and perform web image-based testing. Learn more here: [Web Image-based Testing](https://docs.katalon.com/katalon-studio/docs/web-image-based-testing.html).
