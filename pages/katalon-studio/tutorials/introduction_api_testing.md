...
* [Leverage API to Boost Web Testing with Katalon and LambdaTest course on Katalon Academy](https://academy.katalon.com/courses/api-boost-web-testing-lambdatest/?utm_source=kat_docs_api_intro&utm_medium=bottom_link&utm_campaign=academy_promotion)