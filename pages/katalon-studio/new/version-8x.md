...
* Bug: [Docker Image] Unable to send email reports when running test script from Docker Image. Download Docker Image version 8.3.0 beta here: [Docker Image version 8.3.0 beta](https://hub.docker.com/layers/katalonstudio/katalon/8.3.0.beta/images/sha256-8692d618734401afa962ac0de79d145d01b5fa33d0a97dd7aaca99b8d7ca6766?context=explore).
