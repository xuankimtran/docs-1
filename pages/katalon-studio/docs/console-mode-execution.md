...
2. The **Generate Command for Console Mode** is displayed. Configure your execution with the provided options:
  ...
  * **Executive Platform**:
   ...
   * **Execution Configurations** (Or **Other Options** in versions before 7.7).
      ...
      Available from **version 8.1.0 onwards**, you can terminate execution additionally with the option: **Terminate the execution once the total number of test failures reaches the input threshold**.
