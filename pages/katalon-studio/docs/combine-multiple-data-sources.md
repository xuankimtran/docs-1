...
1. In the **Test Data** table, click **Add** to add data file(s). A **Test Data Browser** dialog opens.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/design-a-test-suite/image2017-6-30-213A473A37.png" width="70%" alt="">
...
2. In the **Test Data Browser** dialog, select a combination of data files you wish to use for variable binding. Click **OK**. The selected test data files appear in the **Test Data** table.
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/data-browser.png" width="70%" alt=""> 

3. Double-click on the **Data Iteration** column to specify the data range.  

    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/data-iteration.png" width="70%" alt=""> 
...
4. Click **Type** to toggle between *One* and *Many*, which represents the test data relationship of multiple test data sources.
    ...
    If you are running a test suite with multiple test data files, you can further define the relationship among them. There are two types of relationship supported in Katalon Studio:
    ...
    <img src="https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/combine-multiple-data-sources/KS-MULTIPLE-Types%20-of-data-relationships.png" width="70%" alt=""> 
