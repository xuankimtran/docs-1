...
If you want to change the global variables in your test case, you must create a new Execution Profile and set it as default Execution Profile, then repeat the steps above to add the new set of values in your test cases.