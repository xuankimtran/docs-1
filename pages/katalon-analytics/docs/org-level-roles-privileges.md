	...
	<tbody>
		...
		<tr>
			...
			<td>
				<p>No access</p>
				<br />
				<p>* Notes: If a User receives a checkout link generated by someone else, they will be able to subscribe and checkout licenses on Katalon TestOps. This is only applicable if there is no predefined Payment Method. See: [Subscription via Quote](https://docs.katalon.com/katalon-studio/docs/license-quote.html#get-quote-via-website).</p>
			</td>
			<td>
				<p>No access</p>
			</td>
