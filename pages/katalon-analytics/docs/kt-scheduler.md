...
description: 
---
You can execute Test Runs one time or on repeats by configuring Test Runs via [Schedule Test Runs](https://docs.katalon.com/katalon-analytics/docs/create-plan.html).
